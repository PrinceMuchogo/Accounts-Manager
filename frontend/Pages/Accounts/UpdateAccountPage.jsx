...
const UpdateAccountPage = () => {
    ...
    const handleSubmitForm = async(e) =>{
        ...
        const confirmed = window.confirm(`Updating account`);

        if(confirmed){

            axios
                .put('http://localhost:5125/api/accounts/update',{
                "_id": "accountId",
                ...
                "notified": notified != '' ? notified : null,
                "isSent": isSent != '' ? isSent : null,
                "status": accountStatus != '' ? accountStatus : null,
                "accountNumber": accountNumber != '' ? accountNumber : null,
                "accountType": accountType != '' ? accountType : null,
                "collectionPoint": collectionPoint != '' ? collectionPoint : null,
                "identificationNumber": identificationNumber != '' ? identificationNumber : null,
                "sourceOfFunds": sourceOfFunds != '' ? sourceOfFunds : null,
    ...
    <div style={{marginTop: '6%'}}>
        ...
        <div style={{ maxWidth: "40%", margin: "0 auto", marginTop: '3%' }}>
            <form onSubmit={(e) =>handleSubmitForm(e)} >
                ...
                <button type="submit" class="btn btn-primary" style={{marginTop: '2%'}}>Update records</button>
            </form>
        </div>
    </div>
  )
